...
``` xml
<PackageReference Include="SourceLink.Test" Version="2.3.0" PrivateAssets="all" />
```
...
``` xml
<PackageReference Include="SourceLink.Embed.AllSourceFiles" Version="2.3.0" PrivateAssets="all" />
```
...
``` xml
<PackageReference Include="SourceLink.Embed.PaketFiles" Version="2.3.0" PrivateAssets="all" />
```
