...
``` xml
<PackageReference Include="SourceLink.Create.GitHub" Version="2.7.3" PrivateAssets="all" />
<DotNetCliToolReference Include="dotnet-sourcelink-git" Version="2.7.3" />
```
...
``` xml
<PackageReference Include="SourceLink.Embed.PaketFiles" Version="2.7.3" PrivateAssets="all" />
```
...
- dotnet pack does not include pdb files by default
  ...
  Update to SourceLink 2.7.3 which [adds .pdb files](https://github.com/ctaggart/SourceLink/pull/291) to the list of files to pack.
